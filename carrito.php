...
<body>
	...
	<div class="main-content">
		...
		<h5>Importante!!</h5>	Completa los siguientes requisitos para poder completar tu compra<br><br>
			<input class="ipt-procom" type="text" id="dirusu" placeholder="Dirección">
			<br>
			<input class="ipt-procom" type="text" id="calle" placeholder="Entre que calles">
			<br>
			<input class="ipt-procom" type="text" id="numerocasa" placeholder="Numero de casa">
			<br>
			<input class="ipt-procom" type="text" id="codigopostal" placeholder="Codigo postal">
			<br>
			...
			<button onclick="procesar_compra()" style="margin-top: 5px;"> Comprar </button>
		</div>
	</div>
			...
			$.ajax({
				...
				success:function(data){
					...
					if (data.datos.length==0) {
						alert("No hay productos en carrito, debes de añadir alguno");
				
						window.history.back();
					}
				    Culqi.settings({
				        title: 'DH STORE TIENDA DE ELECTRONICOS',
				        currency: 'MXN',
