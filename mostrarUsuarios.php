...
$datos=$objLogin->obtenerTodosUsuariosLimitados($desde,$porPagina);
         //obtener todos los usuarios sin paginacion $datos = $objLogin->obtenerTodosUsuarios();
    ?>
       <form action="controlBuscarUsuarios.php" method="GET" class="formularioBusqueda">
    <input type="text" name="txtBusqueda" placeholder="Buscar Usuario">
    <input type="submit" value="Buscar" class="btnBusqueda"> 
